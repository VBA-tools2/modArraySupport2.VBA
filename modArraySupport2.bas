...
Public Sub AddUDFToCustomCategory()
    ...
    With Application
        ...
        .MacroOptions Category:=sCategory, Macro:="ConcatenateVectors"
...
'        .MacroOptions Category:=sCategory, Macro:="IsVariantArrayNumeric"
        ...
        .MacroOptions Category:=sCategory, Macro:="SwapArrayColumns"
        .MacroOptions Category:=sCategory, Macro:="SwapArrayRows"
...
Attribute ConcatenateVectors.VB_ProcData.VB_Invoke_Func = " \n20"
